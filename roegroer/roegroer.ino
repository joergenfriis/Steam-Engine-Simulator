...
#define distMin 50    // anvendes til mapping af output til omraadet 0-100
#define distMax 1000
...
void loop()
{
  ...
  averageA = map(averageA, distMin, distMax, 0, 100);
  ...
  averageB = map(averageB, distMin, distMax, 0, 100);
  ...
  averageC = map(averageC, distMin, distMax, 0, 100);
  ...
  averageD = map(averageD, distMin, distMax, 0, 100);
  ...
  averageE = map(averageE, distMin, distMax, 0, 100);
